...
Variables from the admissions table that influence survival are identified and added to the patients table. This modified table will be called patients_mod1 and will also include derived variables.
...
diagnoses_icd <- read_csv("data/diagnoses_icd.csv")
labevents_1 <- read_csv("data/labevents-1.csv")
